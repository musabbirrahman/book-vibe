        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap items-center gap-4 mt-2">
              ...
              <Link to={`/bookDetails/${book.bookId}`}><button className="px-6 py-2 bg-green-500 hover:bg-green-600 transition-colors text-white rounded-full text-sm font-semibold ml-auto">
                View Details
              </button></Link>
            </div>
          </div>
